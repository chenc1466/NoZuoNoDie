...
void game_init(Game *self)
{
    ...
    al_reserve_samples(20);  // Reserve 20 sample instances
...
bool game_update(Game *self)
{
    ...
    if (scene->scene_end)
    {
        ...
        case 0:
            ...
            break;
        case 1:
            create_scene(Stage_L);
            break;
        case 2:
            create_scene(Set_L);
            break;
        case 3:
            create_scene(New_Level1_0_L);
            break;
        case -1:
            return false;
        default:
...
void switch_bgm(int bgm_type) {
    if(sample_instance != NULL) al_stop_sample_instance(sample_instance);
    switch (bgm_type) {
        case 0:
            song = al_load_sample("assets/sound/bgm1.ogg");
            break;
        case 1:
            song = al_load_sample("assets/sound/bgm2.ogg");
            break;
    }
    ...
    al_play_sample_instance(sample_instance);  // Start playing the BGM
}
